...
═══> """ + TextColors.RESET)
        ...
        if select == "get" or select.lower() == "1":
            ...
            get_requests = int(input(TextColors.WHITE + "Get (5~50) > "+ TextColors.RESET))    
            ...
            url = input(TextColors.WHITE + "URL > "+ TextColors.RESET)
            threads = int(input(TextColors.WHITE + "Thread (5~30) > "+ TextColors.RESET))  
            post_requests = int(input(TextColors.WHITE + "Get (5~50) > "+ TextColors.RESET))   
            ...
            url = input(TextColors.WHITE + "URL > "+ TextColors.RESET)
            threads = int(input(TextColors.WHITE + "Thread (5~30) > "+ TextColors.RESET))  
            head_requests = int(input(TextColors.WHITE + "Get (5~50) > "+ TextColors.RESET))  
